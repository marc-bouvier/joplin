...
const InteropService_Exporter_Mdf = require('lib/services/InteropService_Exporter_Mdf.js');
...
describe('services_InteropService_Exporter_Mdf', function() {
	...
	it('should create resources directory', asyncTest(async () => {
		const service = new InteropService_Exporter_Mdf();
	...
	it('should create note paths and add them to context', asyncTest(async () => {
		const exporter = new InteropService_Exporter_Mdf();
    ...
    it('should begin with frontmatter', asyncTest(async () => {
		const exporter = new InteropService_Exporter_Mdf();
		await exporter.init(exportDir);
        ...
        expect(note1_body).toContain('title: "note1"', 'Note title should be present in frontmatter');
        expect(note2_body).toContain('description: "# Some text "', 'Note description should be present in frontmatter');
		expect(note2_body).toContain('](../../folder3/note3.md)', 'Resource id should be replaced with a relative path.');
		expect(note2_body).toContain('](../../folder1/note1.md)', 'Resource id should be replaced with a relative path.');
		expect(note3_body).toContain('](../folder1/folder2/note2.md)', 'Resource id should be replaced with a relative path.');
	}));
